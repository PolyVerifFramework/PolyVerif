...
def main(args=None):
  ...
  #  adePath = currentpath[0:pos]
   ...
   # print("adepath : ", adePath)
    ...
    gtd_filename = file_path + "/Objects_GTD_Perception.csv"
    auto_percep_file = file_path + "/Autoware_PerceptionData.csv"
    ...
    ComputeParams(gtd_data, auto_percep_data, file_path)
