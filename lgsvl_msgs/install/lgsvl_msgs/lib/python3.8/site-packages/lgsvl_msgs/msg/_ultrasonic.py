...
class Ultrasonic(metaclass=Metaclass_Ultrasonic):
    ...
    def __init__(self, **kwargs):
        ...
        self.minimum_distance = kwargs.get('minimum_distance', float())
    ...
    def __eq__(self, other):
        ...
        if self.header != other.header:
            return False
        if self.minimum_distance != other.minimum_distance:
            return False
        return True
    ...
    def minimum_distance(self):
        """Message field 'minimum_distance'."""
    ...
    def minimum_distance(self, value):
        if __debug__:
            assert \
                ...
                "The 'minimum_distance' field must be of type 'float'"
