...
#include "lgsvl_msgs/msg/detail/detection3_d_array__rosidl_typesupport_fastrtps_c.h"
...
#include "lgsvl_msgs/msg/detail/detection3_d__functions.h"  // detections
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: detections
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, lgsvl_msgs, msg, Detection3D
      )()->data);
