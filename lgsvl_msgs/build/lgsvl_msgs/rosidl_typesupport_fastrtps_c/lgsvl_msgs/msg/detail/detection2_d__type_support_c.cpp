...
#include "lgsvl_msgs/msg/detail/detection2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "lgsvl_msgs/msg/detail/bounding_box2_d__functions.h"  // bbox
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bbox
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, lgsvl_msgs, msg, BoundingBox2D
      )()->data);
    if (!callbacks->cdr_serialize(
