...
static const _SignalArray_type_support_symbol_names_t _SignalArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lgsvl_msgs, msg, SignalArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lgsvl_msgs, msg, SignalArray)),
  }
};
...
{
  return &::lgsvl_msgs::msg::rosidl_typesupport_cpp::SignalArray_message_type_support_handle;
}
