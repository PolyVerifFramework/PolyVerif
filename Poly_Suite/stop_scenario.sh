...
gnome-terminal --tab --title="Stop Scenario" --command="bash -c 'cd ../AutowareAuto;ls; sed -i '3s/.*/pid=${value}/' ../Poly_Suite/support_files/stop_scenario.sh; ade enter ./Poly_Suite/support_files/stop_scenario.sh; $SHELL '"
