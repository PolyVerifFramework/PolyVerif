...
class PublishingSubscriber(Node):
  ...
  def __init__(self):
    ...
    # Create subscriber(s)    
    with open('script/validation_report/Objects_GTD_Perception.csv','w', newline='') as csvfile:
         ...
         writer.writerow(objects_title)
            ...
            # Create subscriber(s)    
    with open('script/validation_report/Autoware_PerceptionData.csv','w', newline='') as csvfile:
         writer = csv.writer(csvfile)
...
#for lg_data
  def lg_callback(self, msg):
      ...
      if len(msg.detections)==0:
         ...
         #print(objects)
         with open('script/validation_report/Objects_GTD_Perception.csv','a', newline='') as csvfile:
            writer = csv.writer(csvfile)          
  ...
  def autoware_callback(self, msg):
      ...
      while len(autoware_boxes) > 0 :
        with open('script/validation_report/Autoware_PerceptionData.csv','a', newline='') as csvfile:
            writer = csv.writer(csvfile)
