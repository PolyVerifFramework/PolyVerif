...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        b_showreport->setGeometry(QRect(200, 210, 131, 27));
        ...
        font3.setWeight(75);
        QListWidgetItem *__qlistwidgetitem = new QListWidgetItem(listWidgetSceneSelectDSU);
        __qlistwidgetitem->setFont(font3);
        new QListWidgetItem(listWidgetSceneSelectDSU);
        new QListWidgetItem(listWidgetSceneSelectDSU);
        new QListWidgetItem(listWidgetSceneSelectDSU);
        new QListWidgetItem(listWidgetSceneSelectDSU);
        new QListWidgetItem(listWidgetSceneSelectDSU);
        listWidgetSceneSelectDSU->setObjectName(QStringLiteral("listWidgetSceneSelectDSU"));
        listWidgetSceneSelectDSU->setGeometry(QRect(0, 0, 171, 121));
        ...
        QListWidgetItem *__qlistwidgetitem1 = new QListWidgetItem(listWidgetSceneSelect);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        const bool __sortingEnabled = listWidgetSceneSelectDSU->isSortingEnabled();
        listWidgetSceneSelectDSU->setSortingEnabled(false);
        QListWidgetItem *___qlistwidgetitem = listWidgetSceneSelectDSU->item(0);
        ___qlistwidgetitem->setText(QApplication::translate("MainWindow", "Select Scene       ", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem1 = listWidgetSceneSelectDSU->item(1);
        ___qlistwidgetitem1->setText(QApplication::translate("MainWindow", "BorregasAve", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem2 = listWidgetSceneSelectDSU->item(2);
        ___qlistwidgetitem2->setText(QApplication::translate("MainWindow", "SanFrancisco", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem3 = listWidgetSceneSelectDSU->item(3);
        ___qlistwidgetitem3->setText(QApplication::translate("MainWindow", "SingleLaneRoad", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem4 = listWidgetSceneSelectDSU->item(4);
        ___qlistwidgetitem4->setText(QApplication::translate("MainWindow", "CubeTown", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem5 = listWidgetSceneSelectDSU->item(5);
        ___qlistwidgetitem5->setText(QApplication::translate("MainWindow", "Jacksonville", Q_NULLPTR));
        listWidgetSceneSelectDSU->setSortingEnabled(__sortingEnabled);
        ...
        const bool __sortingEnabled1 = listWidgetSceneSelect->isSortingEnabled();
        listWidgetSceneSelect->setSortingEnabled(false);
        QListWidgetItem *___qlistwidgetitem6 = listWidgetSceneSelect->item(0);
        ___qlistwidgetitem6->setText(QApplication::translate("MainWindow", "Select Scene       ", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem7 = listWidgetSceneSelect->item(1);
        ___qlistwidgetitem7->setText(QApplication::translate("MainWindow", "BorregasAve", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem8 = listWidgetSceneSelect->item(2);
        ___qlistwidgetitem8->setText(QApplication::translate("MainWindow", "SanFrancisco", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem9 = listWidgetSceneSelect->item(3);
        ___qlistwidgetitem9->setText(QApplication::translate("MainWindow", "SingleLaneRoad", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem10 = listWidgetSceneSelect->item(4);
        ___qlistwidgetitem10->setText(QApplication::translate("MainWindow", "CubeTown", Q_NULLPTR));
        QListWidgetItem *___qlistwidgetitem11 = listWidgetSceneSelect->item(5);
        ___qlistwidgetitem11->setText(QApplication::translate("MainWindow", "Jacksonville", Q_NULLPTR));
        listWidgetSceneSelect->setSortingEnabled(__sortingEnabled1);
