...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        ckbox_perception->setObjectName(QStringLiteral("ckbox_perception"));
        ...
        stackedWidget->setGeometry(QRect(350, 0, 891, 441));
        ...
        horizontalLayout_btnTop->setObjectName(QStringLiteral("horizontalLayout_btnTop"));
        ...
        btn_local_adeStart->setObjectName(QStringLiteral("btn_local_adeStart"));
        ...
        btn_local_sel_scenario->setObjectName(QStringLiteral("btn_local_sel_scenario"));
        ...
        btn_local_StopAde->setObjectName(QStringLiteral("btn_local_StopAde"));
        ...
        scrollScenarioList_2->setObjectName(QStringLiteral("scrollScenarioList_2"));
        ...
        treeWid_local_select_script->setObjectName(QStringLiteral("treeWid_local_select_script"));
        treeWid_local_select_script->setGeometry(QRect(260, 0, 601, 281));
        lbl_sceneSelect = new QLabel(scrollAreaWidgetContents_2);
        lbl_sceneSelect->setObjectName(QStringLiteral("lbl_sceneSelect"));
        lbl_sceneSelect->setGeometry(QRect(1, 1, 105, 19));
        listWid_local_scene_select = new QListWidget(scrollAreaWidgetContents_2);
        listWid_local_scene_select->setObjectName(QStringLiteral("listWid_local_scene_select"));
        ...
        horizontalLayout_btn_bottom->setObjectName(QStringLiteral("horizontalLayout_btn_bottom"));
        ...
        btn_local_avp->setObjectName(QStringLiteral("btn_local_avp"));
        ...
        btn_local_initial_pos->setObjectName(QStringLiteral("btn_local_initial_pos"));
        ...
        btn_local_goal_pos->setObjectName(QStringLiteral("btn_local_goal_pos"));
        ...
        horizontalLayout_btnMiddle->setObjectName(QStringLiteral("horizontalLayout_btnMiddle"));
        ...
        btn_local_scenic_count->setObjectName(QStringLiteral("btn_local_scenic_count"));
        ...
        btn_local_scenic_run->setObjectName(QStringLiteral("btn_local_scenic_run"));
        ...
        btn_local_run_scenario->setObjectName(QStringLiteral("btn_local_run_scenario"));
        ...
        btn_local_stop_scenario->setObjectName(QStringLiteral("btn_local_stop_scenario"));
        ...
        btn_local_showreport->setObjectName(QStringLiteral("btn_local_showreport"));
        ...
        horizontalLayout_btnMiddle_2->setObjectName(QStringLiteral("horizontalLayout_btnMiddle_2"));
        ...
        btn_pp_scenic_count->setObjectName(QStringLiteral("btn_pp_scenic_count"));
        ...
        btn_pp_scenic_run->setObjectName(QStringLiteral("btn_pp_scenic_run"));
        ...
        btn_pp_run_scenario->setObjectName(QStringLiteral("btn_pp_run_scenario"));
        ...
        btn_pp_stop_scenario->setObjectName(QStringLiteral("btn_pp_stop_scenario"));
        ...
        btn_pp_showreport->setObjectName(QStringLiteral("btn_pp_showreport"));

        horizontalLayout_btnMiddle_2->addWidget(btn_pp_showreport);

        scrollScenarioList_3 = new QScrollArea(gbox_path_planning);
        scrollScenarioList_3->setObjectName(QStringLiteral("scrollScenarioList_3"));
        ...
        horizontalLayout_btnTop_2->setObjectName(QStringLiteral("horizontalLayout_btnTop_2"));
        ...
        btn_pp_adeStart->setObjectName(QStringLiteral("btn_pp_adeStart"));
        ...
        btn_pp_sel_scenario->setObjectName(QStringLiteral("btn_pp_sel_scenario"));
        ...
        btn_pp_StopAde->setObjectName(QStringLiteral("btn_pp_StopAde"));
        ...
        horizontalLayout_btn_bottom_2->setObjectName(QStringLiteral("horizontalLayout_btn_bottom_2"));
        ...
        btn_pp_avp->setObjectName(QStringLiteral("btn_pp_avp"));
        ...
        btn_pp_initial_pos->setObjectName(QStringLiteral("btn_pp_initial_pos"));
        ...
        btn_pp_goal_pos->setObjectName(QStringLiteral("btn_pp_goal_pos"));
        ...
        scrollScenarioList->setGeometry(QRect(10, 70, 861, 281));
        scrollScenarioList->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QStringLiteral("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 859, 279));
        ...
        gbox_DST_Control_Suit->setGeometry(QRect(9, 1, 871, 431));
        ...
        listWidgetSceneSelect->setGeometry(QRect(1, 26, 261, 241));
