...
public:
    ...
    QLabel *label_rangeauto;
    QLabel *lbl_d_Precision;
    QLabel *lblRangePrecision;
    QLabel *label_precision;
    QLabel *lbl_d_FNR;
    QLabel *lblRange_FNR;
    QLabel *label_missclassification;
    QLabel *lbl_d_FNR_2;
    QLabel *lblRange_FNR_2;
    QLabel *label_FNR;
    ...
    QLabel *label_posachieved;
    QLabel *lblD_pp_drivableAreaFollowed;
    QLabel *label_posdeviation;
    QWidget *summary;
    ...
    void setupUi(QDialog *reportwindow)
    {
        ...
        tableViewControl->setGeometry(QRect(640, 130, 391, 401));
        ...
        font.setBold(true);
        lblGT->setFont(font);
        lblGT->setAutoFillBackground(true);

        gridLayout->addWidget(lblGT, 1, 1, 1, 1);

        label_lG = new QLabel(layoutWidget1);
        label_lG->setObjectName(QString::fromUtf8("label_lG"));
        QFont font1;
        font1.setFamily(QString::fromUtf8("Ubuntu"));
        font1.setPointSize(11);
        font1.setBold(false);
        font1.setItalic(false);
        label_lG->setFont(font1);
        label_lG->setStyleSheet(QString::fromUtf8("font: 10.5pt \"Ubuntu\";"));

        gridLayout->addWidget(label_lG, 2, 0, 1, 1);

        verticalSpacer_8 = new QSpacerItem(20, 28, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout->addItem(verticalSpacer_8, 6, 1, 1, 1);

        label_aauto = new QLabel(layoutWidget1);
        label_aauto->setObjectName(QString::fromUtf8("label_aauto"));
        label_aauto->setStyleSheet(QString::fromUtf8("font: 10.5pt \"Ubuntu\";"));

        gridLayout->addWidget(label_aauto, 5, 0, 1, 1);
        ...
        label_Reactiontime = new QLabel(layoutWidget1);
        label_Reactiontime->setObjectName(QString::fromUtf8("label_Reactiontime"));
        label_Reactiontime->setStyleSheet(QString::fromUtf8("font: 10.5pt \"Ubuntu\";"));

        gridLayout->addWidget(label_Reactiontime, 8, 0, 1, 1);

        lblBrake = new QLabel(layoutWidget1);
        lblBrake->setObjectName(QString::fromUtf8("lblBrake"));
        lblBrake->setFont(font);
        lblBrake->setAutoFillBackground(true);

        gridLayout->addWidget(lblBrake, 11, 1, 1, 1);
        ...
        lblPer->setFont(font);
        lblPer->setAutoFillBackground(true);

        gridLayout->addWidget(lblPer, 4, 1, 1, 1);

        verticalSpacer_9 = new QSpacerItem(20, 28, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout->addItem(verticalSpacer_9, 10, 1, 1, 1);

        label_brakeapplied = new QLabel(layoutWidget1);
        label_brakeapplied->setObjectName(QString::fromUtf8("label_brakeapplied"));
        label_brakeapplied->setStyleSheet(QString::fromUtf8("font: 10.5pt \"Ubuntu\";"));

        gridLayout->addWidget(label_brakeapplied, 12, 0, 1, 1);

        lblDelayPer = new QLabel(layoutWidget1);
        lblDelayPer->setObjectName(QString::fromUtf8("lblDelayPer"));
        lblDelayPer->setFont(font);
        lblDelayPer->setAutoFillBackground(true);

        gridLayout->addWidget(lblDelayPer, 7, 1, 1, 1);
        ...
        horizontalSpacer_441 = new QSpacerItem(40, 20, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        horizontalSpacer_439 = new QSpacerItem(40, 20, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        horizontalSpacer_440 = new QSpacerItem(40, 20, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        lbl_d_Succes->setAutoFillBackground(true);

        formLayout->setWidget(0, QFormLayout::LabelRole, lbl_d_Succes);

        lblSucceRate = new QLabel(layoutWidget3);
        lblSucceRate->setObjectName(QString::fromUtf8("lblSucceRate"));
        lblSucceRate->setFont(font);
        lblSucceRate->setAutoFillBackground(true);

        formLayout->setWidget(0, QFormLayout::FieldRole, lblSucceRate);

        label_recall = new QLabel(layoutWidget3);
        label_recall->setObjectName(QString::fromUtf8("label_recall"));
        label_recall->setStyleSheet(QString::fromUtf8("font: 10.5pt \"Ubuntu\";"));
        label_recall->setWordWrap(true);

        formLayout->setWidget(1, QFormLayout::SpanningRole, label_recall);

        lbl_d_Auto = new QLabel(layoutWidget3);
        lbl_d_Auto->setObjectName(QString::fromUtf8("lbl_d_Auto"));
        lbl_d_Auto->setAutoFillBackground(true);

        formLayout->setWidget(3, QFormLayout::LabelRole, lbl_d_Auto);

        lblRangeAutoware = new QLabel(layoutWidget3);
        lblRangeAutoware->setObjectName(QString::fromUtf8("lblRangeAutoware"));
        lblRangeAutoware->setFont(font);
        lblRangeAutoware->setAutoFillBackground(true);

        formLayout->setWidget(3, QFormLayout::FieldRole, lblRangeAutoware);

        label_rangeauto = new QLabel(layoutWidget3);
        label_rangeauto->setObjectName(QString::fromUtf8("label_rangeauto"));
        label_rangeauto->setStyleSheet(QString::fromUtf8("font: 10.5pt \"Ubuntu\";"));

        formLayout->setWidget(4, QFormLayout::SpanningRole, label_rangeauto);

        lbl_d_Precision = new QLabel(layoutWidget3);
        lbl_d_Precision->setObjectName(QString::fromUtf8("lbl_d_Precision"));
        lbl_d_Precision->setAutoFillBackground(true);

        formLayout->setWidget(6, QFormLayout::LabelRole, lbl_d_Precision);

        lblRangePrecision = new QLabel(layoutWidget3);
        lblRangePrecision->setObjectName(QString::fromUtf8("lblRangePrecision"));
        lblRangePrecision->setFont(font);
        lblRangePrecision->setAutoFillBackground(true);
        lblRangePrecision->setMargin(0);

        formLayout->setWidget(6, QFormLayout::FieldRole, lblRangePrecision);

        label_precision = new QLabel(layoutWidget3);
        label_precision->setObjectName(QString::fromUtf8("label_precision"));
        label_precision->setStyleSheet(QString::fromUtf8("font: 10.5pt \"Ubuntu\";"));
        label_precision->setWordWrap(true);

        formLayout->setWidget(7, QFormLayout::SpanningRole, label_precision);

        lbl_d_FNR = new QLabel(layoutWidget3);
        lbl_d_FNR->setObjectName(QString::fromUtf8("lbl_d_FNR"));
        lbl_d_FNR->setAutoFillBackground(true);

        formLayout->setWidget(9, QFormLayout::LabelRole, lbl_d_FNR);

        lblRange_FNR = new QLabel(layoutWidget3);
        lblRange_FNR->setObjectName(QString::fromUtf8("lblRange_FNR"));
        lblRange_FNR->setFont(font);
        lblRange_FNR->setAutoFillBackground(true);

        formLayout->setWidget(9, QFormLayout::FieldRole, lblRange_FNR);

        label_missclassification = new QLabel(layoutWidget3);
        label_missclassification->setObjectName(QString::fromUtf8("label_missclassification"));
        label_missclassification->setStyleSheet(QString::fromUtf8("font: 10.5pt \"Ubuntu\";"));

        formLayout->setWidget(10, QFormLayout::SpanningRole, label_missclassification);

        lbl_d_FNR_2 = new QLabel(layoutWidget3);
        lbl_d_FNR_2->setObjectName(QString::fromUtf8("lbl_d_FNR_2"));
        lbl_d_FNR_2->setAutoFillBackground(true);

        formLayout->setWidget(12, QFormLayout::LabelRole, lbl_d_FNR_2);

        lblRange_FNR_2 = new QLabel(layoutWidget3);
        lblRange_FNR_2->setObjectName(QString::fromUtf8("lblRange_FNR_2"));
        lblRange_FNR_2->setAutoFillBackground(true);
        lblRange_FNR_2->setStyleSheet(QString::fromUtf8("font: 700 11pt \"Ubuntu\";"));

        formLayout->setWidget(12, QFormLayout::FieldRole, lblRange_FNR_2);

        label_FNR = new QLabel(layoutWidget3);
        label_FNR->setObjectName(QString::fromUtf8("label_FNR"));
        label_FNR->setStyleSheet(QString::fromUtf8("font: 10.5pt \"Ubuntu\";"));
        label_FNR->setWordWrap(true);

        formLayout->setWidget(13, QFormLayout::SpanningRole, label_FNR);

        verticalSpacer_11 = new QSpacerItem(17, 17, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        formLayout->setItem(5, QFormLayout::LabelRole, verticalSpacer_14);

        verticalSpacer_16 = new QSpacerItem(17, 17, QSizePolicy::Minimum, QSizePolicy::Expanding);

        formLayout->setItem(8, QFormLayout::LabelRole, verticalSpacer_16);

        verticalSpacer_10 = new QSpacerItem(17, 17, QSizePolicy::Minimum, QSizePolicy::Expanding);

        formLayout->setItem(11, QFormLayout::LabelRole, verticalSpacer_10);
        ...
        horizontalSpacer_442 = new QSpacerItem(40, 20, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        horizontalSpacer_443 = new QSpacerItem(40, 20, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        horizontalSpacer_444 = new QSpacerItem(40, 20, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        lbl_local_heading->setGeometry(QRect(20, 60, 581, 51));
        lbl_local_heading->setFrameShape(QFrame::NoFrame);
        ...
        tblV_local_DataReport->setGeometry(QRect(790, 140, 241, 281));
        ...
        lbl_local_minDev->setAutoFillBackground(true);

        gridLayout_2->addWidget(lbl_local_minDev, 4, 0, 1, 1);

        label_max = new QLabel(layoutWidget4);
        label_max->setObjectName(QString::fromUtf8("label_max"));

        gridLayout_2->addWidget(label_max, 3, 0, 1, 1);

        label_mean = new QLabel(layoutWidget4);
        label_mean->setObjectName(QString::fromUtf8("label_mean"));

        gridLayout_2->addWidget(label_mean, 1, 0, 1, 1);

        lblD_local_minDev = new QLabel(layoutWidget4);
        lblD_local_minDev->setObjectName(QString::fromUtf8("lblD_local_minDev"));
        lblD_local_minDev->setFont(font);
        lblD_local_minDev->setAutoFillBackground(true);

        gridLayout_2->addWidget(lblD_local_minDev, 2, 1, 1, 1);

        lblD_local_meanDev = new QLabel(layoutWidget4);
        lblD_local_meanDev->setObjectName(QString::fromUtf8("lblD_local_meanDev"));
        lblD_local_meanDev->setFont(font);
        lblD_local_meanDev->setAutoFillBackground(true);

        gridLayout_2->addWidget(lblD_local_meanDev, 4, 1, 1, 1);
        ...
        tblV_pp_DataReport->setGeometry(QRect(600, 131, 431, 281));
        ...
        horizontalSpacer_445 = new QSpacerItem(40, 20, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        horizontalSpacer_446 = new QSpacerItem(40, 20, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        horizontalSpacer_447 = new QSpacerItem(40, 20, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        lbl_pp_heading->setGeometry(QRect(30, 60, 561, 51));
        lbl_pp_heading->setFrameShape(QFrame::NoFrame);
        ...
        gridLayout_3->addWidget(lbl_pp_drivableAreaFollowed, 6, 0, 1, 1);

        label_collision = new QLabel(layoutWidget5);
        label_collision->setObjectName(QString::fromUtf8("label_collision"));

        gridLayout_3->addWidget(label_collision, 5, 0, 1, 1);
        ...
        lbl_pp_goalPosDeviation->setAutoFillBackground(true);

        gridLayout_3->addWidget(lbl_pp_goalPosDeviation, 2, 0, 1, 1);
        ...
        lbl_pp_goalPosAchieved->setAutoFillBackground(true);
        ...
        lblD_pp_goalPosAchieved->setFont(font);
        lblD_pp_goalPosAchieved->setAutoFillBackground(true);

        gridLayout_3->addWidget(lblD_pp_goalPosAchieved, 0, 1, 1, 1);

        lbl_pp_collisionCount = new QLabel(layoutWidget5);
        lbl_pp_collisionCount->setObjectName(QString::fromUtf8("lbl_pp_collisionCount"));
        lbl_pp_collisionCount->setAutoFillBackground(true);

        gridLayout_3->addWidget(lbl_pp_collisionCount, 4, 0, 1, 1);
        ...
        lblD_pp_collisionCount->setFont(font);
        lblD_pp_collisionCount->setAutoFillBackground(true);

        gridLayout_3->addWidget(lblD_pp_collisionCount, 4, 1, 1, 1);
        ...
        lblD_pp_goalPosDeviation->setFont(font);
        lblD_pp_goalPosDeviation->setAutoFillBackground(true);

        gridLayout_3->addWidget(lblD_pp_goalPosDeviation, 2, 1, 1, 1);

        label_posachieved = new QLabel(layoutWidget5);
        label_posachieved->setObjectName(QString::fromUtf8("label_posachieved"));

        gridLayout_3->addWidget(label_posachieved, 1, 0, 1, 1);
        ...
        gridLayout_3->addWidget(lblD_pp_drivableAreaFollowed, 6, 1, 1, 1);

        label_posdeviation = new QLabel(layoutWidget5);
        label_posdeviation->setObjectName(QString::fromUtf8("label_posdeviation"));

        gridLayout_3->addWidget(label_posdeviation, 3, 0, 1, 1);
    ...
    void retranslateUi(QDialog *reportwindow)
    {
        ...
        label_7->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Delay in Reaction Time:</span></p></body></html>", nullptr));
        ...
        label_lG->setText(QCoreApplication::translate("reportwindow", "After object detection, time available for Ego vehicle to react in LGSVL.", nullptr));
        label_aauto->setText(QCoreApplication::translate("reportwindow", "After object detection, time available for Ego vehicle to react in Autoware.", nullptr));
        label_5->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Reaction Time of Ego in LGSVL:</span></p></body></html>", nullptr));
        label_Reactiontime->setText(QCoreApplication::translate("reportwindow", "Due to perception in autoware there is delay in reaction.", nullptr));
        ...
        label_6->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Reaction Time of Ego in Autoware  :</span></p></body></html>", nullptr));
        ...
        label_brakeapplied->setText(QCoreApplication::translate("reportwindow", "Brake Applied by Ego.", nullptr));
        ...
        lbl_d_Succes->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Detection Success Ratio (True Positive Rate):</span></p></body></html>", nullptr));
        ...
        label_recall->setText(QCoreApplication::translate("reportwindow", "Measures how well the system detects actual objects. High Detection Success Ratio is important for applications where missing objects can lead to serious consequences.", nullptr));
        lbl_d_Auto->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Object Detected in Range :</span></p></body></html>", nullptr));
        ...
        label_rangeauto->setText(QCoreApplication::translate("reportwindow", "Objects present in this range which are detected by Autoware.", nullptr));
        lbl_d_Precision->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Precision :</span></p></body></html>", nullptr));
        lblRangePrecision->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">NA</span></p></body></html>", nullptr));
        label_precision->setText(QCoreApplication::translate("reportwindow", "Reflects the accuracy of the system in identifying objects correctly when it makes a detection. High precision is important for applications where minimizing false detections is crucial, such as in object tracking or quality control in manufacturing.", nullptr));
        lbl_d_FNR->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Missclassification :</span></p></body></html>", nullptr));
        lblRange_FNR->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">NA</span></p></body></html>", nullptr));
        label_missclassification->setText(QCoreApplication::translate("reportwindow", "The system detects an object but misclassifies its type or category.", nullptr));
        lbl_d_FNR_2->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">False Negative Rate :</span></p></body></html>", nullptr));
        lblRange_FNR_2->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">NA</span></p></body></html>", nullptr));
        label_FNR->setText(QCoreApplication::translate("reportwindow", "Indicates how often the system fails to detect objects that are present. Reducing the FNR is crucial for ensuring that all relevant objects are detected, which is critical in safety-critical applications like autonomous vehicles.", nullptr));
        ...
        label_min->setText(QCoreApplication::translate("reportwindow", "Average deviation between the ground truth location and the ego vehicle location.", nullptr));
        ...
        lbl_local_maxDev->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Min Deviation :</span></p></body></html>", nullptr));
        lbl_local_meanDev->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Max Deviation :</span></p></body></html>", nullptr));
        lbl_local_minDev->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Mean Deviation :</span></p></body></html>", nullptr));
        label_max->setText(QCoreApplication::translate("reportwindow", "Minimum deviation between the ground truth location and the ego vehicle location. ", nullptr));
        label_mean->setText(QCoreApplication::translate("reportwindow", "Maximum deviation between the ground truth location and the ego vehicle location. ", nullptr));
        ...
        label_collision->setText(QCoreApplication::translate("reportwindow", "Number of collision occured. ", nullptr));
        lbl_pp_goalPosDeviation->setText(QCoreApplication::translate("reportwindow", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Goal Position Deviation:</span></p></body></html>", nullptr));
        ...
        label_posachieved->setText(QCoreApplication::translate("reportwindow", "Goal position achieved.", nullptr));
        ...
        label_posdeviation->setText(QCoreApplication::translate("reportwindow", "Deviation from actual position given.", nullptr));
