...
statej.transform.position = spawns[0].position + (230 * forward) - (4 * right)
...
statej = lgsvl.AgentState()
statej.transform.position = spawns[0].position + (30 * forward) - (4 * right)
statej.transform.rotation = spawns[0].rotation 
statej.velocity = 10 * forward
...
statej = lgsvl.AgentState()
statej.transform.position = spawns[0].position + (230 * forward)
statej.transform.rotation = spawns[0].rotation 
statej.velocity = 10 * forward
