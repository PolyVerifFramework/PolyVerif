...
state.transform.position = spawns[0].position + 190* forward + 4 * right
state.transform.rotation.y = spawns[0].rotation.y - 2
...
for i in range(1*7):
  ...
  start = spawns[0].position + (100 + (1.0 * (i//7))) * forward  + (2 + (2.0 * (i % 7))) * right
