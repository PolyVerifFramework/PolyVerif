...
print(spawns[0].position + 85 * forward - 0 * right)
...
waypoints.append(lgsvl.WalkWaypoint(position=lgsvl.Vector(155.33599715040458, 8.5, 42.70796304240056),speed = 25, idle=0, trigger_distance=70))
# Second waypoint is across the crosswalk
waypoints.append(lgsvl.WalkWaypoint(position=lgsvl.Vector(159.3713254093677, 8.5, 9.055341604096809), idle=0))
waypoints.append(lgsvl.WalkWaypoint(position=lgsvl.Vector(157.640178507605, 8.5, 45.705890659179296), idle=0))
