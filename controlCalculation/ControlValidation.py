...
def main(args=None):
    ...
    f_path.close()
    print("Calculating Control params.",file_path)

    gtd_filename = file_path + '/Objects_GTD.csv'
    control_filename =file_path + '/Ego_CanData.csv'
    percep_filename = file_path + '/Autoware_PerceptionData.csv'
    ...
    ComputeParams(objects_data, control_data, percep_data, file_path)
