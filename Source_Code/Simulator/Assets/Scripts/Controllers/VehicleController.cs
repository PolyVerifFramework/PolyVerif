...
//Changes_Rahul
    ...
    {
       //  Debug.Log("VC : OnCollision");
        int layerMask = LayerMask.GetMask("Obstacle", "Agent", "Pedestrian", "NPC","BuildingLayer");
      //  Debug.Log($"VC : layerMask :{layerMask}");
        int layer = collision.gameObject.layer;
      //  Debug.Log($"VC : layer : {layer}" );
        string otherLayer = LayerMask.LayerToName(layer);
      //  Debug.Log($"VC : otherLayer : {otherLayer}");
